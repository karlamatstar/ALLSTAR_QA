...
export default function () {
  ...
  if (res.status === 200) {
    ...
    if (json && json.latency_ms) {
      llmLatency.add(json.latency_ms, { tc_id: tc.id, phase_id: PHASE_ID, phase_vus: String(PHASE_VUS), llm_provider: 'amazon-bedrock', llm_model: AI_CHAT_MODEL });
    } else {
