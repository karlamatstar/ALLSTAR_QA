...
:root {
    ...
    --allstar-download-bg:#e7f7ec;
    --allstar-download-hover:#d4f0dd;
    --allstar-download-border:#73b98b;
    --allstar-download-text:#176536;
...
@media (prefers-color-scheme: dark) {
    :root {
        ...
        --allstar-download-bg:#193c2a;
        --allstar-download-hover:#205038;
        --allstar-download-border:#4cae70;
        --allstar-download-text:#b9efcb;
...
.stApp [class*="st-key-report_download_"],
.stApp [class*="st-key-report_download_"] [data-testid="stDownloadButton"] {
    width:fit-content !important; max-width:100% !important;
}
.stApp [class*="st-key-report_download_"] [data-testid="stDownloadButton"] button:not(:disabled) {
    width:auto !important; min-height:2.45rem !important; padding:.45rem 1rem !important;
    background:var(--allstar-download-bg) !important;
    border:1px solid var(--allstar-download-border) !important;
    color:var(--allstar-download-text) !important;
    font-weight:800 !important; box-shadow:none !important;
}
.stApp [class*="st-key-report_download_"] [data-testid="stDownloadButton"] button:not(:disabled) * {
    color:var(--allstar-download-text) !important;
}
.stApp [class*="st-key-report_download_"] [data-testid="stDownloadButton"] button:not(:disabled):hover {
    background:var(--allstar-download-hover) !important;
    border-color:var(--allstar-positive) !important;
}
...
.execution-password-title {color:var(--allstar-selected); font-size:.88rem; font-weight:900; letter-spacing:.01em;}
[class*="st-key-execution_password_"] [data-testid="stVerticalBlockBorderWrapper"] {
    border-color:var(--allstar-selected) !important;
    background:linear-gradient(135deg, rgba(36,95,166,.10), rgba(36,95,166,.03)) !important;
}
