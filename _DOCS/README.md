...
34. `AWS_PUBLIC_ACCESS_AND_EXECUTION_GUARD_PLAN.md`
   - 공개 대시보드·Grafana와 비용·부하·서비스 중단 기능의 실행 보호 경계
35. `AWS_EC2_DOCKER_DEPLOYMENT_RUNBOOK.md`
   - AWS Compose·Caddy·DuckDNS·S3·systemd 구현 파일과 EC2 설치·시작·종료 절차
...
- 2026-07-25 AWS 시연용 활성 테스트케이스를 AI 3건·VOC 3건으로 축소하고 축소 전 6건·10건 원본 보존
...
- 루트 README를 대시보드 상위 7개 탭과 하위 기능 중심으로 전면 정리하고 현재 AI·VOC 각 3건 전체 실행 기준 반영 완료
...
- AWS 전용 Compose·Caddy HTTPS·내부 포트 차단·`service-control` 토큰·DuckDNS·S3 일일 동기화·EC2 systemd 자동화 구현 및 로컬 Docker 검증 완료
