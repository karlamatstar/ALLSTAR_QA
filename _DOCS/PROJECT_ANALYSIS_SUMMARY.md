...
최초 분석 당시 테스트케이스는 총 20개였다. 2026-07-17에 연속된 두 사례마다 대표 한 건을 남겨 10개로 축소했고, 2026-07-25에는 AWS 시연 시간을 줄이기 위해 일반 분석·오타 발화·데이터 없음 대표 3개만 활성화했다. 10개와 20개 원본은 각각 `src/allstar/voc/evaluation/archive/test_cases_10_2026-07-25.json`, `src/allstar/voc/evaluation/archive/test_cases_20_2026-07-17.json`에 보존한다.
