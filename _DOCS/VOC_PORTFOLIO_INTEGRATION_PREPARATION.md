...
과거 20건 구성의 A~D 전체 80건 실행은 약 48분 이상 걸렸고, 2026-07-17에는 프로필별 10건·A~D 전체 40건을 사용했다. 2026-07-25 시연용 활성 범위는 프로필별 3건·A~D 전체 12건으로 축소했다. 모델 응답시간에 따라 실행시간이 달라질 수 있으므로 별도 프로세스와 취소 기능은 유지한다.
