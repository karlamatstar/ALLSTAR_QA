...
- VOC 실행 테스트케이스를 2026-07-17에 20건에서 10건으로, 2026-07-25에 시연용 대표 3건으로 축소하고 20건·10건 원본을 날짜 표시 아카이브로 보존
- AI 에이전트 실행 테스트케이스를 시연용 대표 3건으로 축소하고 직전 6건 원본을 날짜 표시 아카이브로 보존
...
- 위 실제 결과는 2026-07-17~18 당시 범위이며, 2026-07-25 현재 활성 실행 범위는 AI 3건·VOC 3건이다.
...
- 당시 데이터 기준 전체 10건과 실제 LLM 평가 대상 9건을 확인창과 실행 설정에 표시했으며 현재는 파일 기반으로 3건을 자동 표시
...
- 당시 VOC 테스트케이스 전체 10건·실제 AI 대상 9건·장애 전용 1건 안내와 A~D 카드를 확인했으며 현재 활성 3건도 동일한 동적 계산 경로를 사용
